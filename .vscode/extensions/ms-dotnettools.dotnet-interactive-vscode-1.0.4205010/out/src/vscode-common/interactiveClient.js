...
const tokenGenerator_1 = require("./polyglot-notebooks/tokenGenerator");
    ...
    submitCommandAndGetResult(command, commandType, expectedEventType, token) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            let disposable = this.subscribeToKernelTokenEvents(token, eventEnvelope => {
                var _a;
                if (((_a = eventEnvelope.command) === null || _a === void 0 ? void 0 : _a.token) === token && eventEnvelope.eventType === expectedEventType) {
                    switch (eventEnvelope.eventType) {
                        case contracts_1.CommandFailedType:
                            if (!handled) {
                                handled = true;

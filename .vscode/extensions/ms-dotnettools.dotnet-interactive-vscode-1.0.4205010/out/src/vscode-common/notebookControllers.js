...
const contracts = require("./polyglot-notebooks/contracts");
            ...
            switch (e.message.preloadCommand) {
                case '#!connect':
                    this.config.clientMapper.getOrAddClient(notebookUri).then(() => {
                        ...
                        vscodeNotebookManagement.hashBangConnect(this.config.clientMapper, hostUri, (e.message.kernelInfos), this.uriMessageHandlerMap, (arg) => controller.postMessage(Object.assign(Object.assign({}, arg), { webViewId: e.message.webViewId })), notebookUri);
